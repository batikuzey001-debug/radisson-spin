...
from .sayfalar.kod_yonetimi import router as kod_router         # /admin/kodyonetimi
from .sayfalar.turnuvabonus import router as tb_router          # /admin/turnuvabonus
from .sayfalar.admin_yonetim import router as admin_yn_router   # /admin/users
...
admin_router.include_router(kod_router)        # /admin/kodyonetimi

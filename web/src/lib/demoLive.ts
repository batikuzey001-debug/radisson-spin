// web/src/lib/demoLive.ts  (majör ligler için isim/logolar küçük revize — gerekirse aynen bırak)
...
export function getDemoItems(): DemoItem[] {
  return [
    {
      id: 1001,
      league: { name: 'Premier League', logo: 'https://cdn.sportmonks.com/images/soccer/leagues/8/8.png' },
    ...
    {
      id: 1003,
      league: { name: 'Süper Lig', logo: 'https://cdn.sportmonks.com/images/soccer/leagues/332/332.png' },
    ...
    {
      id: 1004,
      league: { name: 'Serie A', logo: 'https://cdn.sportmonks.com/images/soccer/leagues/384/384.png' },
    ...
    {
      id: 1005,
      league: { name: 'Bundesliga', logo: 'https://cdn.sportmonks.com/images/soccer/leagues/82/82.png' },
    ...
    {
      id: 1006,
      league: { name: 'Ligue 1', logo: 'https://cdn.sportmonks.com/images/soccer/leagues/301/301.png' },
